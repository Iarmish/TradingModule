...
namespace ShortPeakRobot.Constants
{
    public static class RobotsInitialization
    {
        public static readonly Dictionary<int, RobotBaseModel> dictionary = new Dictionary<int, RobotBaseModel>()
        {
            ...
            { 3, new RobotBaseModel{Id = 3, Name= "LastDayHL-BNB-D1", Symbol = "BNBUSDT" , AlgorithmName = "LastDayHL"} },             
            { 4, new RobotBaseModel{Id = 4, Name= "ShortPeak-BTC-D1", Symbol = "BTCUSDT" , AlgorithmName = "ShortPeak"} },              
            { 5, new RobotBaseModel{Id = 5, Name= "ShortPeak-ETH-D1", Symbol = "ETHUSDT" , AlgorithmName = "ShortPeak"} },            
            { 6, new RobotBaseModel{Id = 6, Name= "ShortPeak-ETH-D1", Symbol = "ETHUSDT" , AlgorithmName = "ShortPeak"} },             
            { 7, new RobotBaseModel{Id = 7, Name= "LastDayHL-SOL-D1", Symbol = "SOLUSDT" , AlgorithmName = "LastDayHL"} },            
            { 8, new RobotBaseModel{Id = 8, Name= "ShortPeak-ETH-D1", Symbol = "ETHUSDT", AlgorithmName = "ShortPeak"} },            
            { 9, new RobotBaseModel{Id = 9, Name= "ShortPeak-BTC-D1", Symbol = "BTCUSDT" , AlgorithmName = "ShortPeak"} },            
            { 10, new RobotBaseModel{Id = 10, Name= "LastDayHL-LTC-D1", Symbol = "LTCUSDT" , AlgorithmName = "LastDayHL"} },            
            { 11, new RobotBaseModel{Id = 11, Name= "ShortPeak-ETH-D1", Symbol = "ETHUSDT" , AlgorithmName = "ShortPeak"} },            
            { 12, new RobotBaseModel{Id = 12, Name= "ShortPeak-BTC-D1", Symbol = "BTCUSDT" , AlgorithmName = "ShortPeak"} },            
            ...
            { 15, new RobotBaseModel{Id = 15, Name= "ShortPeak-BTC-D1", Symbol = "BTCUSDT" , AlgorithmName = "ShortPeak"} },
            ...
            { 19, new RobotBaseModel{Id = 19, Name= "ShortPeak-XRP-D1", Symbol = "XRPUSDT" , AlgorithmName = "ShortPeak"} },
            { 20, new RobotBaseModel{Id = 20, Name= "ShortPeak-XRP-D1", Symbol = "XRPUSDT" , AlgorithmName = "ShortPeak"} },
